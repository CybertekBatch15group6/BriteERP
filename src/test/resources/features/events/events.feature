...
Feature: Annual company event
  ...
  Scenario Outline: Create and post the event
    ...
    And user provides "<Event Name>", "<Start Date>", "<End Date>", and "<Minimum Attendees>" and clicks on confirm event

    Examples:
      |modules |Event Name        |Start Date |End Date  |Minimum Attendees|
      |Events  |Annual Conference |06/06/2020 |06/08/2020|2300             |